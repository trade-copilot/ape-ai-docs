...
**Time:** Setup 10 minutes | Learning ongoing **Platform:** ✅ Both iOS & Web **Best for:** 🌱 First-time investors & traders **Prerequisites:** Ape AI account (free), Sage companion recommended for learning
...
1. Go to **Chat**
2. Ask AI: _"What are good beginner-friendly stocks to learn with?"_
...
1. Go to **Chat**
2. Ask: _"What's a simple options trade for a beginner to learn with? I have a paper trading account."_
...
* _"I bought a $185 call on AAPL expiring next Friday. Explain how this makes money."_
* _"What happens if AAPL goes to $190?"_
* _"What happens if it drops to $170?"_
* _"When should I sell this option?"_
...
* _"How is my AAPL call doing?"_
* _"Should I take profits or hold?"_
* _"What did I learn from this trade?"_
* _"What should I do differently next time?"_
...
❌ **Thinking paper trading is the same as real** - Emotions are different ❌ **Taking huge risks** - Just because it's fake money ❌ **Not learning** - Paper trading without reflection wastes time ❌ **Rushing to real money** - Give yourself time to learn ❌ **Ignoring losses** - Losses teach you more than wins
...
* [Learning Options Trading Guide](../Trader/learning-options-paper.md)
...
* [Morning Market Check](../Advanced/monthly-review.md)
...
* [Options Basics](../Trader/first-options-trade.md)
