...
**⏱️ Time:** 10-15 minutes **💰 Cost:** Free (knowledge that prevents costly mistakes) **📱 Platform:** Any device **👤 Best for:** Complete beginners learning when they can trade **🦍 Recommended Companion:** Sage (clear explanation of market timing)
...
* 🕐 You want to know when you can buy and sell stocks
...
* Example: Regular hours $0.02 spread → Pre-market $0.20 spread
...
* [Your First $100 in ETFs →](../../Beginner/first-100-etfs.md)
* [Your First $100 in Stocks →](../../Beginner/first-100-stocks.md)
