...
![iOS News Feed](<../../.gitbook/assets/TV - 32.png>)
...
![Web News Feed](<../../.gitbook/assets/TV - 33.png>)
...
> **NVDA Earnings Beat 🚀** Revenue: $18.1B (expected $16.2B) - BEAT EPS: $4.02 vs $3.37 expected - BEAT Stock: +8% pre-market Key: Data center revenue up 112% YoY
...
> **Goldman Sachs Upgrades TSLA** Rating: Neutral → Buy Price Target: $500 (from $450) Reason: Strong delivery numbers, China growth Stock: +2.3%
...
> **Fed Holds Rates Steady 🏦** Decision: 5.25%-5.50% unchanged Powell: "Inflation still elevated"
...
> **Apple Announces Vision Pro Launch Date 🥽** Release: February 2, 2024 Price: $3,499 Pre-orders start January 19 Analyst take: "Game changer for spatial computing" AAPL: +1.2%
...
> **GME Unusual Options Activity 🎯** Alert: 10x normal call volume Strikes: $30-$35 exp Friday Premium flow: $15M+ into calls Possible catalyst: Earnings next week GME: +12% on the day
...
> **Tech Sector Rally Continues 💻** QQQ: +2.1% this week Leaders: NVDA (+8%), AMD (+6%), MSFT (+4%) Driver: AI optimism, strong earnings Outlook: Momentum likely to continue
...
**📱 iOS: Discover → ⚙️ Settings** **🌐 Web: Home → Customize Feed**
...
**Q: Can I see news for stocks not in my portfolio?** A: Yes! Search any ticker → View ticker page → News tab shows all news for that stock.

**Q: Why don't I see all financial news?** A: Personalized = filtered for relevance. You only see news about stocks you care about.

**Q: Can I change news sources?** A: Yes! Settings → News Sources → Select which sources you want.
