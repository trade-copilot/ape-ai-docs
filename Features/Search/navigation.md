...
**⏱️ Time to read:** 3 minutes **📱 Platform:** Both platforms (different layouts)
...
![iOS Bottom Navigation](<../../.gitbook/assets/TV - 4 (2).png>)

***

### Top Bar Elements (iOS)

**Left:** Profile icon → Settings, Brokerages, Account **Center:** Current screen title **Right:** Search icon, notifications
...
**Left:** Ape AI logo → Home **Center:** Search bar **Right:** Profile menu, notifications
...
**Q: Where's the old feature \[X]?** A: Check Settings → Help if you can't find something.
...
**Navigation = Get Where You Need to Go, Fast! 🧭⚡**
