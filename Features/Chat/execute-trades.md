...
**⏱️ Time to read:** 5 minutes **📱🌐 Platform:** Both iOS & Web **👤 Best for:** Active traders with connected brokerages
...
[Learn how to connect →](../Brokerage/why-connect.md)
...
**📱 iOS:** Tap the button **🌐 Web:** Click the button
...
**📱 iOS:** Tap **"Place Order"** **🌐 Web:** Click **"Confirm & Place Order"**
...
**Q: Can I cancel an order after placing it?** A: Yes, go to Portfolio → Orders → Cancel (if order hasn't filled yet).
...
**Q: What brokerages support this?** A: Most major brokers. See [Supported Brokerages →](../Brokerage/supported.md)
