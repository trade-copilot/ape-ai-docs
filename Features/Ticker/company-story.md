...
**Ticker Page → Company Section**
- Scroll to Company tab/section
- Full story + key metrics
- Links to competitors

<!-- TODO: Screenshot missing: company-story-section.png -->

---

## ❓ FAQ

**Q: Is Company Story AI-generated?**
A: Yes, AI synthesizes from multiple sources, writes in simple language.

**Q: How often is it updated?**
A: When major business changes occur (acquisitions, pivots, etc.).

**Q: Can I see financial statements here?**
A: Basic info here. Full financials in Financials tab.
...
**Company Story = Understand What You're Buying! 📖🏢**
