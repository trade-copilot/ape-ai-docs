...
* **News Feed** 🏠 - Market overview, news, trending
...
* **AI Snapshot Grades** - 4 letter grades (A to F) ⭐
...
**Platform Comparison:** Not sure which to use? → [iOS vs Web Comparison](../platforms/comparison/)
